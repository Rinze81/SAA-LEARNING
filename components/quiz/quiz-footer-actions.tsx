      ...
      <div className="grid gap-4">
        ...
        <div className="grid gap-3">
          ...
          <button
            ...
            className="inline-flex min-h-[50px] items-center justify-center rounded-full border border-slate-800 px-5 text-sm font-semibold text-slate-100 transition hover:-translate-y-0.5"
          >
            {session.isMarkedForReview ? "復習リストから外す" : "あとで復習する"}
          </button>
        </div>
